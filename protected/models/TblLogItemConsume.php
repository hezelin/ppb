...
/**
 * This is the model class for table "log_item_consume".
 *
 * The followings are the available columns in table 'log_item_consume':
 * @property integer $id
 ...
 */
class TblLogItemConsume extends PlatformActiveRecord
{
	/**
	 ...
	 * @return TblLogItemConsume the static model class
	 */
