...
class TblActivationTotalController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('TblActivationTotal');
	 ...
	 * @param TblActivationTotal $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tbl-activation-total-form')
		{
